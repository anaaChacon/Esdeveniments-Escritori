...
--
-- Servidor: localhost
-- Tiempo de generación: 14-04-2017 a las 12:58:50
...
CREATE TABLE `lugares` (
  ...
  `horario` varchar(40) COLLATE latin1_spanish_ci NOT NULL,
  `coor_latitud` float NOT NULL,
  `coor_longitud` float NOT NULL,
